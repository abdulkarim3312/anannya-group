    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('client_add') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('image') ? 'has-error' :'' }}">
                            <label for="image" class="col-sm-2 col-form-label">Image (200 x 67) <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
