    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('team_add') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('phone') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('phone') }}" name="phone" class="form-control" id="phone" placeholder="Enter Facebook Link">
                                @error('phone')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row {{ $errors->has('whats_app_link') ? 'has-error' :'' }}">
                            <label for="whats_app_link" class="col-sm-2 col-form-label">What's App No <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('whats_app_link') }}" name="whats_app_link" class="form-control" id="whats_app_link" placeholder="Enter Twitter Link">
                        ...
                        <div class="form-group row {{ $errors->has('we_chat_link') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('we_chat_link') }}" name="we_chat_link" class="form-control" id="we_chat_link" placeholder="Enter Instagram Link">
                                @error('we_chat_link')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
