                ...
                <form class="form-horizontal" method="POST" action="{{ route('user.add') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('role') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control role select2" style="width: 100%;" name="role"
                                    id="role">
                                    <option value="1" {{ old('role') == 1 ? 'selected' : '' }}>Admin</option>
{{--                                    <option value="2" {{ old('role') == 2 ? 'selected' : '' }}>SR</option>--}}
                                </select>
                        ...
                        <div class="form-group extra_sr_field row {{ $errors->has('mobile_no') ? 'has-error' :'' }}">
                            <label for="mobile_no" class="col-sm-2">Mobile No <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group extra_sr_field row {{ $errors->has('address') ? 'has-error' :'' }}">
