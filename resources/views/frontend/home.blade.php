        ...
        <div class="slide kenburns" style="background-image:url({{ asset($banner->image) }});">
            ...
            <div class="container">
                <div class="slide-captions text-center text-light">
                    <!-- Captions -->
                    <span class="strong">{{ $banner->title ?? '' }}</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div class="d-flex justify-content-center contactsection">
                        <div>
                            <a class="btn" href="{{route('frontend_contact_us')}}">&nbsp;CONTACT US&nbsp;<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                        <div class="dItem" style="padding-left:2%;border: 3px solid blue;height: 40px;"><span class="mt-2 font_size" style="font-size:25px; color:red">Hotline call +880 1324-448350 /1324-448333</span></div>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <section style="margin-top: -50px !important;">
        <div class="container">
            <div class="col-md-12 text-left pt-3 color-black">
                <h3 class="Title" style="color: #2250fc">EXPERIENCE OF 21 YEARS</h3>
            </div>
