    ...
    <section id="page-title" data-bg-parallax="{{ asset('themes/frontend/images/parallax/14.jpg') }}">
        ...
        <div class="container">
            <div class="page-title">
                <h1 class="text-uppercase text-medium">ECO Friendly Bricks Machinery</h1>
            </div>
        </div>
    </section>
    <!-- end: Page title -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading-text heading-section">
                        <h2>ABOUT COMPANY</h2>
                        <span class="lead">M/S Bismillah Enterprise is a 33 years old company. It is renowned for the Import and Export of various types of products all over Bangladesh. It has a great reputation for maintaining product supply chain management for the well-being of the company. Mainly, it is well known for collecting feed and raw materials from different places in Bangladesh and supplying to factories according to their needs all over Bangladesh.
                            The products are Rhapsody, Sayake, Corn, DOB, Dry Fees, CGM, and Poultry Mill for poultry food and the human foods are Sugar, Wheat, Lentil dill, and Vegetable oil. Besides these, M/S Bismillah Enterprise imports and exports all types of animal feed medicine with great care.
                            </span>
                    </div>
                </div>
            </div>
