    ...
    <section id="page-title" data-bg-parallax="{{ asset('themes/frontend/images/parallax/14.jpg') }}">
        ...
        <div class="container">
            <div class="page-title">
                <h1 class="text-uppercase text-medium">Others Machinery's</h1>
            </div>
        </div>
    </section>
    <!-- end: Page title -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading-text heading-section">
                        <h2>ABOUT COMPANY</h2>
                        <span class="lead">Quick Consumer Food provides products in a wide variety of fields that directly affect our daily lives. This Company covers everything from the procurement of raw materials to the delivery of goods to consumer markets, these operations include foods (Sugar, Grains, Oils and Fats, Dairy and Processed foods). We provide consumers with products and services that help to enrich their daily lives. </span>
                    </div>
                </div>
            </div>
        </div>
