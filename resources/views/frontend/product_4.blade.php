    ...
    <section id="page-title" data-bg-parallax="{{ asset('themes/frontend/images/parallax/14.jpg') }}">
        ...
        <div class="container">
            <div class="page-title">
                <h1 class="text-uppercase text-medium">Garments</h1>
            </div>
        </div>
    </section>
    <!-- end: Page title -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading-text heading-section">
                        <h2>ABOUT COMPANY</h2>
                        <span class="lead">While garment, textile & sweater manufacturing industries are flourishing and playing a vital role in the economy of Bangladesh, Bismillah Sweater has added a radiant chapter of quality and competitiveness to the readymade garment scenario by establishing a factory.
                            Bismillah Sweater is one of the leading 100% export-oriented sweater manufacturing industries in Bangladesh. The factory was purposely built to meet foreign catalogue buyers and the country’s legal and safety environment which fully covered compliance, especially fire safety, social as well as local rules and regulations of the Government. The factory was established with updated manufacturing equipment, advanced technology and a modern management system.
                            </span>
                    </div>
                </div>
            </div>
