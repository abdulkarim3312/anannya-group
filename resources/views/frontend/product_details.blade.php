            ...
            <div class="product">
                <div class="row m-b-40">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-md-5">
                            <a href="tel:01678172718" class="btn btn-primary">Contact Us 01678172718</a>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                {{-- <div class="row m-b-40">
                    <div class="content col-lg-12">
                        <h5 class="mb-4"><i class="icon-arrow-right"> </i>Product Video</a></h5>
                        <div class="col-md-6 mx-auto">
                            <iframe width="420" height="315" src="{{$product->youtube_link ?? ''}}">
                            </iframe>
                            <iframe height="480" width="500" src="https://www.youtube.com/watch?v=7OhKedanFq0">
                            </iframe>
                        </div>
                    </div>
                </div> --}}
                ...
                <div class="tabs tabs-folder">
                    ...
                    <div class="tab-content" id="myTabContent3">
                        <div class="tab-pane fade active show" id="home3" role="tabpanel" aria-labelledby="home-tab">
                            <iframe src="{{ asset($product->quotation) }}" width="50%" height="1000"></iframe>
                        </div>
                        <div class="tab-pane fade " id="profile3" role="tabpanel" aria-labelledby="profile-tab">
                            <iframe src="{{ asset($product->catalogue) }}" width="50%" height="1000"></iframe>
                        </div>
                    </div>
                </div>
            </div>
