                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @if (Auth::user()->role == 1)
                            ...
                            $subMenu = [
                                ...
                                'video_gallery', 'video_gallery_add', 'video_gallery_edit','certificate', 'certificate_add', 'certificate_edit','category_banner_add'
                            ];
                            ?>
                            <li
                                class="nav-item {{ in_array(Route::currentRouteName(), $subMenu) ? 'menu-open' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <?php
                                    $subSubMenu = ['category_banner_add'];
                                    ?>
                                    <li class="nav-item">
                                        <a href="{{ route('category_banner_add') }}"
                                            class="nav-link {{ in_array(Route::currentRouteName(), $subSubMenu) ? 'active' : '' }}">
                                            <i
                                                class="far  {{ in_array(Route::currentRouteName(), $subSubMenu) ? 'fa-check-circle' : 'fa-circle' }} nav-icon"></i>
                                            <p>Category Banner</p>
